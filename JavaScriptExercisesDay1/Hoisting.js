...
// To uncomment fast press cmd+shift+7
...
// (function(){
//     var foo = 1;
//     alert(foo + " " + bar + " " + baz); // SEE CONSOLE.LOG this will print the referenceError mentioned before, since baz is no longer declared anywhere.
//     var bar = 2;
// }())
...
// foo(); // SEE CONSOLE.LOG this will, as one might pressume, not give a referenceError, it will however give an exception since the variable foo is not instanciated as a function until after the foo(); call
// var foo = function(){
//     alert("Hello!");
// }